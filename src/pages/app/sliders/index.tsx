...
import { useDeleteSliderMutation, useGetSlidersQuery, type Slider } from "@/store/services/slidersApi";
...
const tableKey = TAGS_KEY.SLIDER;
...
export default function Sliders() {
  ...
  const { data, isLoading } = useGetSlidersQuery(tableState);
  ...
  const columns: CustomColumnDef<Slider>[] = [
    {
      header: "Title",
      accessorKey: "title",
